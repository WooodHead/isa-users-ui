...
export const TermsAndConditions = (props: Props) => {
  return (
    <div>
      ...
      <p>
        International Slackline Association is committed to ensuring that the
        app is as useful and efficient as possible. For that reason, we reserve
      ...
      <p>
        The ISA Account app stores and processes personal data that you have
        ...
        features and it could mean that the ISA Account app won't work properly
        or at all.
      </p>
      <p></p>
      <p>
      ...
      <p>
        With respect to International Slackline Association's responsibility for
        ...
        to us so that we can make it available to you. International Slackline
        Association accepts no liability for any loss, direct or indirect, you
        experience as a result of relying wholly on this functionality of the
        app.
      </p>
      <p>
        At some point, we may wish to update the app. The app is currently
        available as a web application. International Slackline Association does
        not promise that it will always update the app so that it is relevant to
      ...
      <p>These terms and conditions are effective as of 2022-08-24</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at account@slacklineinternational.org.
      </p>
    </div>
  );
};
